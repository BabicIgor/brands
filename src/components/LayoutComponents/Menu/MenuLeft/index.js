        ...
        <div className="menuLeft__logo">
          {params.collapsed ? (
            <div className="menuLeft__logoContainer menuLeft__logoContainer--collapsed">
              <img style={{display: 'none'}} src="resources/images/logo-inverse-mobile.png" alt="" />
              <i className="fa fa-bars menu-collapse" onClick={this.onCollapse}> </i>
            </div>
          ) : (
            <div className="menuLeft__logoContainer">
              <img style={{display: 'inline'}} src="resources/images/logo-inverse.png" alt="" />
              <i className="fa fa-bars menu-collapse" onClick={this.onCollapse}></i>
            </div>
          )}
        </div>
